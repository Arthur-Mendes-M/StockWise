...
import { CompanyUpdateDataValidator, CompanyCredentialsValidator, CompanyFormDataValidator } from "../_validations/Company.js";
...
// Unprotected route
async function getCompanyByCredentials(request, response) {
    console.log("entrou");
...
function putCompany(request, response) {
...
// Unprotected route
async function postCompany(request, response) {
    const companyFormData = { ...request.body, image: request.file };
